...
* **Example:** Begin a project with the **Market Analyst** on a large-context model (e.g., Claude) to synthesize market trends. Then, hand off that summary to a custom **Creative Strategist** on a creative model (e.g., ChatGPT) to generate campaign concepts.